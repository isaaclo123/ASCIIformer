...
public class functions {	
	...
	public static void gravity() {
		int i = 0;
		while (i < (variables.level[variables.levelnum][controls.a].length - 1)){
	...
	public static void checkscore(){
		if (variables.level[variables.levelnum][controls.a][controls.b].equals("*"))
		{
			variables.score = variables.score + 100;
		}
		else if (variables.level[variables.levelnum][controls.a][controls.b].equals("ʌ"))
		{
			variables.score = variables.score - 100;
...
public static void checklife(){
	if (variables.hp == 0){
		...
		controls.b = 1;
		variables.level[variables.levelnum][controls.a][controls.b] = "☻";
